...
assert.deepEqual(Array.from(plans.djPlans,p=>[p.id,p.amountCents,p.interval,p.maxPlayers]),[['serato-weekly',1995,'week',25],['serato-pro',4995,'month',75],['serato-pro-plus',6995,'month',100]]);
