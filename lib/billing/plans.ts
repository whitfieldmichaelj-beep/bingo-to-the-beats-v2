...
export const djPlans: HostPlan[] = [
  ...
  { id: "serato-pro", name: "DJ Pro", amountCents: 4995, interval: "month", maxPlayers: 100, serato: true, description: "For DJs hosting every weekend." },
  { id: "serato-pro-plus", name: "DJ Pro Plus", amountCents: 5999, interval: "month", maxPlayers: 200, serato: true, description: "For larger weekly events." },
];
